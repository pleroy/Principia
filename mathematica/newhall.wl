...
(*Module[{c=NewhallC[degree,divisions,w]},*)
(*Table[*)
(*Sum[*)
(*c[[n]]Coefficient[ChebyshevT[n-1,x],x,k],*)
(*{n,1,degree+1}],*)
(*{k,0,degree}*)
(*]]*)
...
(* ::Input:: *)
(*GroupElementPairs[matrix_List]:=(*Print[ToString[CForm[*)Table[Table[{matrix[[i,2j-1]],matrix[[i,2j]]},{j,1,Length[matrix[[i]]]/2}],{i,1,Length[matrix]}](*]]]*)*)
...
(*StringReplace[*)
(*ToString[CForm[GroupElementPairs[matrix]]],*)
(*{"List(List(List("->"            {{",*)
(*"List(List("->"             {",*)
(*"List("->"\r\n             {",*)
(*"),"->" * Second},",*)
...
(*file=*)
(*OpenWrite[*)
(*FileNameJoin[{DirectoryName[NotebookDirectory[]],"numerics","newhall_matrices.mathematica.h"}],BinaryFormat->True,PageWidth->Infinity];*)
(*WriteString[*)
(*file,*)
(*FromCharacterCode[16^^ef]<>FromCharacterCode[16^^bb]<>FromCharacterCode[16^^bf]<>*)
(*"// Generated by Mathematica.  DO NOT EDIT!\r\n",*)
(*"// source: mathematica/newhall.wl\r\n",*)
(*"\r\n",*)
(*"#include <array>\r\n",*)
(*"\r\n",*)
...
(*"FixedMatrix","DirectSum<double, Time>",ToString[degree]<>" + 1", "8 + 1",*)
...
(*{degree, 3, 17}];*)
(*WriteString[file, "}  // namespace internal\r\n","\r\n"];*)
(*Do[*)
(*WriteString[file,ToString["using internal::newhall_c_matrix_\:0447\:0435\:0431\:044b\:0448\:0451\:0432_degree_",CharacterEncoding->"UTF8"]<>ToString[degree]<>"_divisions_8_w04;\r\n"];*)
(*WriteString[file,ToString["using internal::newhall_c_matrix_monomial_degree_",CharacterEncoding->"UTF8"]<>ToString[degree]<>"_divisions_8_w04;\r\n"],*)
(*{degree, 3, 17}];*)
(*WriteString[*)
(*file,*)
(*"\r\n",*)
