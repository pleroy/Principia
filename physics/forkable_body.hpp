...
bool ForkableIterator<Tr4jectory, It3rator, T1meline>::operator==(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator& ForkableIterator<Tr4jectory, It3rator, T1meline>::operator++() {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
typename T1meline::ConstIterator
ForkableIterator<Tr4jectory, It3rator, T1meline>::current() const {
  return current_;
}

template<typename Tr4jectory, typename It3rator, typename T1meline>
not_null<Tr4jectory const*>
ForkableIterator<Tr4jectory, It3rator, T1meline>::trajectory() const {
  CHECK(!ancestry_.empty());
  return ancestry_.back();
}

template<typename Tr4jectory, typename It3rator, typename T1meline>
void ForkableIterator<Tr4jectory, It3rator, T1meline>::NormalizeIfEnd() {
  CHECK(!ancestry_.empty());
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void ForkableIterator<Tr4jectory, It3rator, T1meline>::CheckNormalizedIfEnd() {
  CHECK(current_ != ancestry_.front()->timeline_end() ||
        ancestry_.size() == 1);
}
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::DeleteFork(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
bool Forkable<Tr4jectory, It3rator, T1meline>::is_root() const {
  return parent_ == nullptr;
}

template<typename Tr4jectory, typename It3rator, typename T1meline>
not_null<Tr4jectory const*> Forkable<Tr4jectory, It3rator, T1meline>::root() const {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
not_null<Tr4jectory*> Forkable<Tr4jectory, It3rator, T1meline>::root() {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::Begin() const {
  not_null<Tr4jectory const*> ancestor = root();
  return Wrap(ancestor, ancestor->timeline_begin());
}

template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::End() const {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::Find(Instant const& time) const {
  It3rator iterator;
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::LowerBound(Instant const& time) const {
  It3rator iterator;
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::Fork() const {
  CHECK(!is_root());
  not_null<Tr4jectory const*> ancestor = that();
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
int Forkable<Tr4jectory, It3rator, T1meline>::Size() const {
  int result = 0;
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::WritePointerToMessage(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
not_null<Tr4jectory*> Forkable<Tr4jectory, It3rator, T1meline>::ReadPointerFromMessage(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
not_null<Tr4jectory*> Forkable<Tr4jectory, It3rator, T1meline>::NewFork(
    Instant const & time) {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::DeleteAllForksAfter(Instant const& time) {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::DeleteAllForksBefore(Instant const& time) {
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::WriteSubTreeToMessage(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
void Forkable<Tr4jectory, It3rator, T1meline>::FillSubTreeFromMessage(
...
template<typename Tr4jectory, typename It3rator, typename T1meline>
It3rator Forkable<Tr4jectory, It3rator, T1meline>::Wrap(
